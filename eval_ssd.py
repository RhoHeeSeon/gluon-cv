...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='pikachu',
                        help='eval dataset.')
...
def get_dataset(dataset, data_shape):
    ...
    elif dataset.lower() == 'pikachu':
        val_dataset = gdata.RecordFileDetection('pikachu_val.rec')
        classes = ['pikachu']
...
if __name__ == '__main__':
    ...
    if not args.deploy:
        if args.pretrained.lower() in ['true', '1', 'yes', 't']:
            ...
            net = gcv.model_zoo.get_model(net_name, pretrained_base=False, classes=classes)
        else:
            print('**2')
